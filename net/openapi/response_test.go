...
func Example_useCase() {
	// To simplify response handling and avoid writing logic to parse default structure of OpenAPI might look like:
	/*
	...
	*/
	...
	// You can simply use generic function `ExtractResponse[T any](resp *http.Response)` from this package.
	// For example if you could have struct:
